    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="page-title">
                <h2>
                    <span class="fa fa-arrow-circle-o-left"></span>Create User</h2>
            </div>
            <!-- END PAGE TITLE -->
            ...
            <div class="page-content-wrap">
            	<form:form method="POST"
          			action="/lazz/admin/user/createuser" modelAttribute="usermodel" >
                        ...
                        <div class="block">
                            ...
                            <div class="panel-body m-b-20">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" placeholder="User ID will auto generate" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select multiple class="form-control select" name="userGroups.usrGrpId" data-live-search="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select" name="userTypes.utId" data-live-search="true">
