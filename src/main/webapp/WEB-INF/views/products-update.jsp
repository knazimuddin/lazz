        ...
        <div class="page-content">
            ...
            <div class="page-content-wrap">
            	<form:form method="POST"
          			id="productmodel" action="/lazz/admin/product/updateproduct" modelAttribute="productmodel" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="block">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <input type="text" name="prdName" value="${productmodel.prdName}" class="form-control" placeholder="Enter the product name...">
                                    </div>
                                </div>
                                
                                <input type="hidden" name="prdId" value="${productmodel.prdId}" />

                                <!-- div class="form-group">
                                    <label class="col-12 control-label">Product ID</label>
                                    <div class="col-12">
                                        <input type="text" name="prdUnqId" value="${productmodel.prdUnqId}" class="form-control" placeholder="Product ID will auto generate" readonly>
                                        <input type="hidden" name="prdId" value="${productmodel.prdId}" />
                                    </div>
                                </div-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <input type="text" name="prdSkuNum" value="${productmodel.prdSkuNum}" class="form-control" placeholder="Enter the product's SKU number" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <input type="number" name="prdRetailPoints" value="${productmodel.prdRetailPoints}" class="form-control" placeholder="Enter points for retail">
                                    </div>
                                </div>
                               ...
                               <%--  <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <input type="number" name="prdRulesPoints" value="${productmodel.prdRulesPoints}" class="form-control" placeholder="Enter points for this price rules">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-12">
                                        ...
                                        <input type="number" name="prdRetailPrice" value="${productmodel.prdRetailPrice}" class="form-control" placeholder="Enter Product Price">
                                    </div>
                                </div>
