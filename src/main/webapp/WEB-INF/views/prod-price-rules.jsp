...
<head>
    ...
    <script type="text/javascript">
    	...
    	function updateView(){
    		var formObj = document.getElementById("prdpricerulesmodel");
    		var usrGrpId = document.getElementById("usrGrpSel").value;
    		formObj.action = "/lazz/admin/price/display-product-price-rules-update-view/"+usrGrpId;
    		formObj.method = "POST";
	    	formObj.submit();
    	}
		                                    ...
		                                    <div class="block">
		                                        <div class="panel panel-default">
		                                            <div class="panel-heading">
		                                                ...
		                                                <input type="hidden" name="prdPrcRuleId" value="${prdCfg.products.prdId}" />
		                                            </div>
		                                            <div class="panel-body">
		                                                <div class="table-responsive">
		                                                    <table class="table table-bordered table-striped table-actions">
		                                                        ...
		                                                        <tbody>
		                                                        	<c:forEach items="${prdCfg.prdPriceRuleses}" var="priceRules">
		                                                            	<tr id="trow_1">
			                                                                <td class="text-center">
			                                                                    <strong>${priceRules.prdPrcRuleCarton}</strong>
			                                                                </td>
			                                                                <td>${priceRules.prdPrcRulePriceWest}</td>
			                                                                <td>${priceRules.prdPrcRulePriceEast}</td>
			                                                                <td>
			                                                                    <button href="user-add-price.html" onclick="updateView()" class="btn btn-default btn-rounded btn-sm" data-toggle="tooltip" title="Edit">
